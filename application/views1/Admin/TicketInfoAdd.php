			        ...
			        <form action="" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
			            <div class="box-body">
				            ...
				            <div class="row col-md-12">    
				                ...
				                <div class="form-group col-md-6">
				                  	<label class="control-label"> Equipment Type </label><label class="pull-right" id="InWarrenty" style="color: green ;"><?php if(isset($in_warrenty)){ if($in_warrenty == 1) { echo "In Warranty"; } } ?></label>
									<div>
