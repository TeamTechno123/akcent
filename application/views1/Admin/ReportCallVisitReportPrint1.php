...
<div class="wrapper">
  <!-- Main content -->
  <div class="row">
    <p style="text-align:center; font-size:17px;"> <b>Call Visit Report</b>  </p>
  </div>
  <table class="table table-bordered mb-0 invoice-table">
    ...
    <!-- <tr>
      ...
      <td align="center" colspan="3" style="border-right:0px!important; ">
    ...
    <td   colspan="6" >
      <div class="" style="float:left;">
        ...
        <div class="" style="text-align:center;">
                        <h3 style="font-family: Calibri, Candara, Segoe, 'Segoe UI'; font-size:36px; font-weight:bold; text-transform:uppercase;" > <?php echo $GetCmpInfo['name']; ?></h3>
                          ...
                          <p  style="margin-bottom:5px; font-family: Calibri, Candara, Segoe, 'Segoe UI'; font-size: 16px;"> Mobile No: <?php echo $GetCmpInfo['mobile_no_1']; ?> &nbsp; | &nbsp; GST No: <?php echo $GetCmpInfo['gst_no']; ?> </p>
    ...
    <tr>
      <td colspan="6" class="">   <p> <b>Remark Any</b>  : </p>
        </td>
    </tr>

    <tr>
      <td Width="50%" colspan="3" class="" style="border-right:0px!important;">  <p> <b>Name</b>  :  </p>
        </td>
