    		...
    		<div class="col-md-4">
          		<div class="box box-info">
            		<div class="box-header with-border">
              			<h3 class="box-title"><i class="fa fa-plus"></i> Add Problem Info </h3>
            		</div>
			        <div class="box-body table-responsive">
						<form action="" method="POST" accept-charset="utf-8">
				            <div class="box-body">
					            ...
					            <div class="row col-md-12">    
					                <div class="form-group">
					                  	<label class="setting control-label"> Problem Info Name <label class="text-red">*</label> </label>
										<div>
		                	...
		                	<tbody>
			                	<?php if($setting) { foreach ($setting as $setting) { ?>
			                		<tr>
			                			...
			                			<td align="center"> 
			                				<a href="<?php echo site_url('Admin/ProblemInfo/EditProblemInfo/').$setting['id']; ?>"><i class="fa fa-pencil"></i></a>&nbsp&nbsp&nbsp&nbsp&nbsp
			                				<a href="<?php echo site_url('Admin/ProblemInfo/DeteleProblemInfo/').$setting['id']; ?>" onclick="return confirm('Delete Confirm');"><i class="fa fa-trash"></i></a>
			                			</td>
			                		</tr>
			                	<?php } } ?>
			                </tbody>
