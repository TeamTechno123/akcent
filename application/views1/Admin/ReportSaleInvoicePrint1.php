...
<div class="wrapper">
  <!-- Main content -->
  <div class="row">
    <p style="text-align:center; font-size:17px;"> <b>Tax Invoice</b>  </p>
  </div>
  ...
  <tr>
    <td   colspan="3">
      <b> Terms : </b><br>
                ...
                <p style="margin-bottom:3px;">Bank Name : HDFC Bank </p>
                <p style="margin-bottom:3px;">A/C No &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; :  50200025345757</p>
                ...
                <div style="overflow: hidden;">
                  <p style="float: left;margin-bottom:3px;">Branch & IFSC Code : Kudal & HDFC0002494</p>
