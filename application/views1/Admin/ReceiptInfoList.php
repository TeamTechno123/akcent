    	...
    	<div class="row">
          ...
          <div class="box box-info">
          	<div class="box-header with-border">
                ...
                <a href="<?php echo site_url('Admin/ReceiptInfo/ReceiptInfoAdd'); ?>" class="btn btn-primary btn-sm"><i class="fa fa-plus"></i> Add </a> 
             </div>
        		</div>
                ...
                <tbody>
                  <?php if(!empty($datas)) { foreach ($datas as $d) { ?>
                    <tr>  
                      ...
                      <td>
                        <div>
                          <a href="<?php echo site_url('Admin/ReceiptInfo/ReceiptInfoEdit/').$d['id']; ?>"><i class="fa fa-pencil"></i></a>&nbsp&nbsp&nbsp&nbsp&nbsp
                          <a href="<?php echo site_url('Admin/ReceiptInfo/ReceiptInfoDelete/').$d['id']; ?>" onclick="return confirm('Delete Confirm');"><i class="fa fa-trash"></i></a>
                        </div><br>
                      </td>        
                    </tr>           
                  <?php } } ?>
