			            ...
			            <div class="box-body">
				            ...
				            <div class="row col-md-12">
				            	...
				            	<div class="form-group col-md-3">
									...
									<div>
		                    			<input type="text" class="form-control" name="content_person" id="content_person" placeholder="Enter Party contact person name" value="<?php if(isset($content_person)){ echo $content_person; } ?>">
		                    		</div>		
				                </div>
				                <div class="form-group col-md-3">
				                  	<label class="control-label"> Party Contact No.  </label>
									<div>
		                    			<input type="text" class="form-control" name="content_no" id="content_no" placeholder="Enter Party Contact No." value="<?php if(isset($content_no)){ echo $content_no; } ?>">
		                    		</div>		
				                </div>
				            </div>
				        </div> 
