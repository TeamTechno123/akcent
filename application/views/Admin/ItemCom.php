    ...
    <section class="content">
    	<div class="callout callout-danger" id="delete_info" style="display: none;">
	        <h4>Delete Warning !</h4>
	         This Item Company is Used In AMC Contract Info
      	</div>
    	<div class="row">
    		<div class="col-md-4">
          		<div class="box box-info">
            		<div class="box-header with-border">
              			<h3 class="box-title"><i class="fa fa-plus"></i> Add-Setting </h3>
            		</div>
				            ...
				            <div class="box-body">
					            <div class="row col-md-12">    
					                <div class="form-group">
					                  	<label class="setting control-label"> Item Company Name <label class="text-red">*</label> </label>
										<div>
		                	...
		                	<tbody>
			                	<?php if($setting) { foreach ($setting as $setting) { ?>
			                		<tr>
			                			...
			                			<td align="center"> 
			                				<a href="<?php echo site_url('Admin/ItemCom/EditItem/').$setting['id']; ?>"><i class="fa fa-pencil"></i></a>&nbsp&nbsp&nbsp&nbsp&nbsp
			                				<a href="<?php echo site_url('Admin/ItemCom/DeteleItem/').$setting['id']; ?>" onclick="return confirm('Delete Confirm');"><i class="fa fa-trash"></i></a>
			                			</td>
			                		</tr>
			                	<?php } } ?>
			                </tbody>
