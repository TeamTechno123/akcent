    ...
    <section class="content">
    	<div class="callout callout-danger" id="delete_info" style="display: none;">
	        <h4>Delete Warning !</h4>
	         This Equipment Type Used In AMC Contract Info
      	</div>
    	<div class="row">
    		<div class="col-md-4">
          		<div class="box box-info">
            		<div class="box-header with-border">
              			<h3 class="box-title"><i class="fa fa-plus"></i> Add Equipment Type </h3>
            		</div>
				            ...
				            <div class="box-body">
					            <div class="row col-md-12">    
					                <div class="form-group">
					                  	<label class="setting control-label"> Equipment type Name <label class="text-red">*</label> </label>
										<div>
		                	...
		                	<tbody>
			                	<?php if($setting) { foreach ($setting as $setting) { ?>
			                		<tr>
			                			...
			                			<td align="center"> 
			                				<a href="<?php echo site_url('Admin/ItemGroup/EditItem/').$setting['id']; ?>"><i class="fa fa-pencil"></i></a>&nbsp&nbsp&nbsp&nbsp&nbsp
			                				<a href="<?php echo site_url('Admin/ItemGroup/DeteleItem/').$setting['id']; ?>" onclick="return confirm('Delete Confirm');"><i class="fa fa-trash"></i></a>
			                			</td>
			                		</tr>
			                	<?php } } ?>
			                </tbody>
