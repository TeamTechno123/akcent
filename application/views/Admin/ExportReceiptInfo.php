			          ...
			          <div class="box-body table-responsive">
                        ...
                        <?php foreach ($datas as $k) { ?>
                          <tr>
                            ...
                            <td> <?php echo $k['receipt_no']; ?> </td>
                            <td> <?php echo $k['party_name']; ?> </td>
                            <td> <?php echo $k['name']; ?> </td>
                            <td> <?php echo $k['contract_ref_no']; ?> </td>
                            <td> <?php echo $k['receipt_amt']; ?> </td>
                            <td> <?php if($k['payment_mode'] == 1){ echo "Cash"; } if($k['payment_mode'] == 2) { echo "Cheque"; } if($k['payment_mode'] == 3) { echo "Online Transfer"; } ?> </td>
                            <td> <?php echo $k['remark']; ?> </td>
