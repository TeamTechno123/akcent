	...
	<body class="hold-transition skin-blue sidebar-mini">
		<div class="wrapper">
			<header class="main-header">
			    <a href="<?php echo site_url('Technical/Home'); ?>" class="logo">
        			...
        			<ul class="nav navbar-nav">
          				<li class="dropdown user user-menu">
            				<a href="#" class="dropdown-toggle" data-toggle="dropdown">
	              				<img src="<?php echo base_url('files/dist/img/user.png'); ?>" class="user-image" alt="User Image">
	              				<span class="hidden-xs"><?php echo $this->session->userdata('technical_mobile'); ?></span>
            				</a>
            				<ul class="dropdown-menu">
	              				<li class="user-header">
	                				<img src="<?php echo base_url('files/dist/img/user.png'); ?>" class="img-circle" alt="User Image">
	                				<p><?php echo $this->session->userdata('technical_mobile'); ?></p>
	              				</li>
	              				<li class="user-footer" style="background-color: #e4e4e4;">
	                				<div class="pull-left"><a href="<?php echo site_url('Technical/Profile'); ?>" class="btn btn-block btn-success">Profile</a></div>
	                				<div class="pull-right"><a href="<?php echo site_url('Technical/Login/Logout'); ?>" class="btn btn-block btn-danger">Sign out</a></div>
	              				</li>	
	            			</ul>
          				</li>
		    	...
		    	<div class="user-panel">
		      	...
		      	<ul class="sidebar-menu" data-widget="tree">
		        	...
		        	<li class="<?php if($this->session->userdata('topmenu') == 'Dashboard') { echo 'active'; } ?>">
		         		<a href="<?php echo site_url('Technical/Home'); ?>"><i class="fa fa-dashboard"></i> <span>Dashboard</span></a>
		        	</li>
		         	<li class="treeview <?php if($this->session->userdata('topmenu') == 'Transactions') { echo 'active'; } ?>">
		         		...
		         		<ul class="treeview-menu">
				            <li class="<?php if($this->session->userdata('submenu') == 'Approve Call Visit') { echo 'active'; } ?>">
				            	<a href="<?php echo site_url('Technical/CallVisit'); ?>"><i class="fa fa-circle-o"></i> Approve Call Visit </a>
				            </li>
				            <li class="<?php if($this->session->userdata('submenu') == 'Sale Invoice') { echo 'active'; } ?>">
				            	<a href="<?php echo site_url('Technical/SaleInvoice'); ?>"><i class="fa fa-circle-o"></i> Sale Invoice </a>
				            </li>
		         		</ul>
		         	</li>	
		        </ul>
