          		...
          		<div class="box box-info">
			        ...
			        <form action="" method="POST" accept-charset="utf-8" enctype="multipart/form-data">
			            <div class="box-body">
				            ...
				            <div class="row col-md-12">    
				                ...
				                <div class="form-group col-md-6">
				                  	...
				                  	<label class="pull-right" id="InWarrenty" style="color: green ;"><?php if(isset($datas['in_warrenty'])){ if($datas['in_warrenty'] == 1) { echo "In Warrenty"; } } ?></label>
									<div>
				        ...
				        <div class="box-footer">
				            <a href="<?php echo site_url('Party/TicketInfo'); ?>"><button type="button" class="btn btn-primary pull-right">Back</button></a>
				        </div>    
			        </form>			       
          		</div>
     		</div>
