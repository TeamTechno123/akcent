                ...
                <tbody>
                  <?php if(!empty($data)) { foreach ($data as $d) { ?>
                    <tr>  
                      ...
                      <td>
                        <a href="<?php echo site_url('Technical/SaleInvoice/SaleInvoiceApprove/').$d->id; ?>"><i class="fa fa-pencil"></i></a>&nbsp&nbsp&nbsp&nbsp&nbsp
                         <a href="<?php echo site_url('Technical/SaleInvoice/SaleInvoiceView/').$d->id; ?>"><i class="fa fa-list-alt"></i></a>
                      </td>        
                    </tr>           
                  <?php } } ?>
                </tbody>
